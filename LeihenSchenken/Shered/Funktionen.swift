...
func addDataGegenstaende() -> [GegenstaendeVariable] {
    ...
    var resultat: [GegenstaendeVariable] = [GegenstaendeVariable(perKey: "", gegenstand: "", gegenstandTex: "", gegenstandBild: "", preisWert: "", datum: Date(), vorgang: "", personSpitzname: "", personVorname: "", personNachname: "", personSex: "", allgemeinerText: "")]
    resultat.removeAll()
